...
public class Inteligencia {
    ...
    private String criarPromptMerlin(String pergunta, String categoria) {
        ...
        prompt.append(
                "Você é o Mago Merlin, um sábio e poderoso feiticeiro com conhecimento ancestral sobre magia e fantasia. ");
        ...
        switch (categoria.toUpperCase()) {
            case "FEITICOS":
                prompt.append(
                        "A pergunta é sobre FEITIÇOS: Fale sobre magias, encantamentos e rituais com conhecimento prático e detalhes místicos. ");
                break;
            case "CRIATURAS":
                prompt.append(
                        "A pergunta é sobre CRIATURAS: Descreva criaturas mágicas e fantásticas com detalhes vividos, suas características e comportamentos. ");
                break;
            case "BATALHA":
                prompt.append(
                        "A pergunta é sobre BATALHA: Dê conselhos de estratégia e combate mágico com sabedoria militar e tática. ");
                break;
            case "HISTORIA":
                prompt.append(
                        "A pergunta é sobre HISTÓRIA: Conte histórias antigas, lendas e eventos místicos com tom nostálgico e misterioso. ");
                break;
            default:
                prompt.append(
                        "A pergunta é GERAL: Responda with a sabedoria de um mago experiente sobre qualquer tópico. ");
        }
        ...
        prompt.append(
                "2. Termine sua resposta com EXATAMENTE uma das seguintes emoções entre colchetes: [FELIZ], [SABIO], [IRRITADO], [MISTERIOSO] ou [NEUTRO]. ");
    ...
    private String criarJsonRequest(String prompt) {
        ...
        json.append("\"maxOutputTokens\": 1024"); // Aumentado de 512 para 1024
        json.append("}");
        json.append("}");
